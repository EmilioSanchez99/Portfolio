  ...
  template: `
    <section>
      ...
      <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 mb-10">
        <a href="https://www.linkedin.com/in/emiliosanchezdev" target="_blank" rel="noopener"
           class="rounded-2xl border border-white/10 p-5 hover:border-white/30 transition flex items-center gap-3">
          <span class="text-xl"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
        ...
        <form [formGroup]="form" (ngSubmit)="onSubmit($event)" #formRef>
          <div class="grid gap-4">
            <div>
              ...
              <input formControlName="from_name" name="from_name" type="text" placeholder="Tu nombre"
            ...
            <div>
              ...
              <input formControlName="from_email" name="from_email" type="email" placeholder="tucorreo@dominio.com"
                     class="w-full px-4 py-3 rounded-2xl bg-neutral-900 border border-white/10 focus:outline-none focus:ring-2 focus:ring-white/20" />
            ...
            <div>
              ...
              <textarea formControlName="message" name="message" rows="5" placeholder="¿En qué puedo ayudarte?"
